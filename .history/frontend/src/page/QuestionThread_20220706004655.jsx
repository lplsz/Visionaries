            ...
            if (r.name !== me) {
              return (
                <div style={{ display: 'flex', marginBottom: '10px', }}>
                  ...
                  <div style={{ flex: 4, fontSize: '5px', color: 'gray', margin: '5px', marginTop: '0px' }}>{r.time}</div>
                </div>
              )
            } else {
              return (
                <div>
                  ...
                  <div style={{ display: 'flex', flex: 4, fontSize: '5px', color: 'gray', margin: '5px', marginTop: '0px', alignContent: 'flex-end', justifyContent: 'flex-end' }}>{r.time}</div>
                </div>
