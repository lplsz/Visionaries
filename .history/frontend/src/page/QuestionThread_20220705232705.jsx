      ...
      >
        ...
        >
          {qaList.map((q, i) => {
            if (q.new !== 0) {
              return (
                <Tab classes={{ wrapper: { textAlign: "right" } }} label={<StyledBadge color="secondary" badgeContent={q.new}><div style={{ textAlign: 'left' }}>{q.question}</div></StyledBadge>}{...a11yProps(i)} sx={{ minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start" }} />
              )
            } else {
              return (
