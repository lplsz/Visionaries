  ...
  return (
    <div>
      <div style={{ width: '100%', display: 'flex' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center' }}> <button onClick={() => { console.log('hehe'); setDate(getFirstDayOfNextWeek(date)) }}>{'<<'}</button></div>
        <div style={{ flex: 4, textAlign: 'center' }}> {l[0] + '-' + l[4]}</div>
