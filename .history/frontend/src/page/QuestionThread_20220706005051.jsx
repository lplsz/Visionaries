            ...
            if (r.name !== me) {
              return (
                <div>
                  ...
                  <div style={{ display: 'flex', marginBottom: '10px' }}>
                    ...
                    <div style={{ marginRight: '10px', display: 'flex', flex: 8, fontSize: '5px', color: 'gray', margin: '5px', marginTop: '0px', alignContent: 'flex-end', justifyContent: 'flex-start' }}>{r.time}</div>
              ...
              return (
                <div>
                  ...
                  <div style={{ display: 'flex', marginBottom: '10px' }}>
                    <div style={{ flex: 4 }}></div>
                    <div style={{ display: 'flex', flex: 8, fontSize: '5px', color: 'gray', margin: '5px', marginTop: '0px', alignContent: 'flex-end', justifyContent: 'flex-end' }}>{r.time}</div>
                    <div style={{ flex: 1 }}></div>
                  </div>
                </div>
