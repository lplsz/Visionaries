...
export default function QuestionThread() {
            ...
            if (r.name !== me) {
              return (
                <div style={{ display: 'flex', marginBottom: '10px', }}>
                  <div style={{ flex: 1 }}><Avatar {...stringAvatar(r.name)} /></div>
                  <div style={{ flex: 6 }}>{r.body}</div>
              ...
              return (
                <div style={{ display: 'flex', marginBottom: '10px' }}>
                  <div style={{ flex: 4 }}></div>
                  <div style={{ display: 'flex', flex: 6, alignContent: 'flex-end', justifyContent: 'flex-end' }}>
                    <div style={{ borderRadius: '15px', background: 'gray', paddingLeft: '15px', paddingRight: '15px', paddingTop: '8px', paddingBottom: '8px' }}>{r.body}</div>
                  </div>
                  <div style={{ display: 'flex', flex: 1, alignContent: 'flex-end', justifyContent: 'flex-end' }}><Avatar {...stringAvatar(r.name)} /></div>
                </div>
              )
            }
  ...
  return (
    <div>
      <ExpertHeader />
      <div style={{ display: 'flex', marginLeft: '80', marginTop: '40px' }}>
      ...
      <div style={{ marginLeft: '80px', marginRight: '80px' }}>
        ...
        >
          <Tabs
            ...
            sx={{
              borderRight: 1, borderColor: 'divider', width: 450, float: 'left',
            }}
          >
            {qaList.map((q, i) => {
              if (q.new !== 0) {
