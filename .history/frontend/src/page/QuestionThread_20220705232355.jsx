      ...
      >
        ...
        >
          {qaList.map((q, i) => {
            if (q.new !== 0) {
              return (
                <StyledBadge color="secondary" badgeContent={q.new}> <Tab classes={{ wrapper: { textAlign: "right" } }} label={<div style={{ textAlign: 'left' }}>q.question</div>}{...a11yProps(0)} sx={{ minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start" }} /></StyledBadge>

              )
            }
          })}

          <Tab classes={{ wrapper: { textAlign: "right" } }} label={<StyledBadge color="secondary" badgeContent={99}> <div style={{ textAlign: 'left' }}>Item1</div> </StyledBadge>}{...a11yProps(0)} sx={{ minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start" }} />

          <Tab label="Item Two" {...a11yProps(1)} sx={{
            minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start"
          }} />
          <Tab label="Item Three" {...a11yProps(2)} sx={{ width: '100%' }} />
          <Tab label="Item Four" {...a11yProps(3)} sx={{ width: '100%' }} />
          <Tab label="Item Five" {...a11yProps(4)} sx={{ width: '100%' }} />
          <Tab label="Item Six" {...a11yProps(5)} sx={{ width: '100%' }} />
          <Tab label="Item Seven" {...a11yProps(6)} sx={{ width: '100%' }} />
        </Tabs>
