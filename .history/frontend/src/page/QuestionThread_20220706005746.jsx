...
export default function QuestionThread() {
  ...
  const HandleReply = (props) => {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', marginTop: '20px', height: '350px', weight: '450px', overflow: 'hidden', overflowY: 'scroll' }}>
        {
