        ...
        <div style={{ display: 'flex', width: '100%', backgroundColor: '#ffffff', borderRadius: '10px' }}>
          ...
          >
            <div style={{ margin: 'auto' }}>
              <Typography variant="h5">Available Time <Button sx={{ justifyContent: 'flex-end', alignItems: 'flex-end', marginTop: '5px', borderColor: 'gray', height: '35px', color: '#74b2a4' }} variant="outlined"> Submit </Button></Typography>
