      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        {
          props.q.reply.map((r, i) => {
            ...
            if (r.name !== me) {
              return (
                <div style={{ display: 'flex', marginBottom: '10px', alignContent: 'flex-end', justifyContent: 'flex-end' }}>
                  <div style={{ flex: 1 }}><Avatar {...stringAvatar(r.name)} /></div>
                  <div style={{ flex: 6, alignContent: 'flex-end', justifyContent: 'flex-end' }}>{r.body}</div>
