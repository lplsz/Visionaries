              ...
              return (
                <div>
                  ...
                  <div style={{ display: 'flex', marginBottom: '10px' }}>
                    ...
                    <div style={{ marginRight: '15px', display: 'flex', flex: 8, fontSize: '5px', color: 'gray', margin: '5px', marginTop: '0px', alignContent: 'flex-end', justifyContent: 'flex-start' }}>{r.time}</div>
