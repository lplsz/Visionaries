      ...
      return (
        <Grid container spacing={0}>
          {lls.map((bo, y) => {
            if (bo) {
              return (
                <Grid item xs={2.4} sx={{ justifyItem: 'center' }}> <div style={{ height: '90%', width: '90%', background: week[y], fontWeight: 'bold', color: 'black', fontSize: '8px', textAlign: 'center' }}>{time[x]}</div></Grid>
              )
            } else {
