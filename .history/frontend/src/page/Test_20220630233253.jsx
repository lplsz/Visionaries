  ...
  return (
    <div style={{ width: '400px', height: '300px' }} >
      ...
      <div style={{ width: '100%', display: 'flex' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center' }}> <IconButton size='small' onClick={() => { console.log('hehe'); setDate(getFirstDayOfLastWeek(date)); setI(i + 1) }}><KeyboardDoubleArrowRightIcon /></IconButton></div>
