        ...
        >
          ...
          >
            {qaList.map((q, i) => {
              if (q.new !== 0) {
                return (
                  <Tab classes={{ wrapper: { textAlign: "right" } }} label={<StyledBadge color="secondary" badgeContent={q.new}><div style={{ textAlign: 'left', width: '100%' }}>{q.question}</div></StyledBadge>}{...a11yProps(i)} sx={{ minWidth: '300px', width: '300px', right: '0', alignItems: "flex-start", paddingRight: 5 }} />
                )
              } else {
                return (
