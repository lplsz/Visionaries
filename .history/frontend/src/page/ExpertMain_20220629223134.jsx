        ...
        <div style={{ display: 'flex', width: '100%', backgroundColor: '#ffffff', borderRadius: '10px', marginBottom: '10px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyItems: 'center', marginTop: '20px' }}>
              <div style={{ border: '1px solid', borderRadius: '10px', background: '#f48fb1', padding: '5px', margin: '5px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyItems: 'center' }}>
                <div><InterpreterModeIcon sx={{ margin: 'auto', fontSize: 60, color: 'white' }} /> </div>
                <Button sx={{ marginTop: '5px', borderColor: 'gray', height: '55px', color: '#b25977', background: 'white' }} fullWidth variant="outlined">Schedule Meeting</Button>
              </div>
