        ...
        <div style={{ display: 'flex', width: '100%', backgroundColor: '#ffffff', borderRadius: '10px', marginBottom: '10px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyItems: 'center', marginTop: '20px' }}>
              <div style={{ borderRadius: '10px', flex: 2, height: '180px', background: '#f48fb1', padding: '5px', margin: '5px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyItems: 'center' }}>
                <div>
                  <img style={{ width: '70px', height: '870px' }} src={QAICON} alt={'image'} />
                </div>
                <Button sx={{ marginTop: '5px', borderColor: 'white', height: '55px', color: '#b25977', background: 'white' }} fullWidth variant="outlined">Follow my Answered Questions</Button>
              </div>
              <div style={{ borderRadius: '10px', height: '180px', flex: 3, background: '#74b2a4', padding: '5px', margin: '5px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyItems: 'center' }}>
                <div>
                  <img style={{ width: '70px', height: '70px' }} src={POSTICON} alt={'image'} />
                </div>
                <Button sx={{ marginTop: '5px', flex: 1, borderColor: 'white', height: '55px', color: '#b25977', background: 'white' }} fullWidth variant="outlined">{"Add a New Q&A task"} </Button>
                <Button sx={{ marginTop: '5px', flex: 1, borderColor: 'white', height: '55px', color: '#b25977', background: 'white' }} fullWidth variant="outlined">Manage My Posts</Button>
