  ...
  return (
    <div style={{ width: '300px', height: '300px' }} >
      ...
      <Grid container spacing={0} cent>
        <Grid item xs={2.4} sx={{ background: '#ea9999', fontWeight: 'blod', color: 'white', textAlign: 'center' }}>
          MON
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#f9cb9c', color: 'white', textAlign: 'center' }}>
          TUE
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#ffe599', color: 'white', textAlign: 'center' }}>
          WED
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#a2c4c9', color: 'white', textAlign: 'center' }}>
          THU
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#aa9dcb', color: 'white', textAlign: 'center' }}>
          FRI
        </Grid>
      </Grid>
