...
const ExpertMain = () => {
  ...
  const [qaList, setQaList] = React.useState([
    { name: 'Rhea', question: 'How much does it cost?', category: 'vacation', answer: 'All appointments are completely free of charge for students who are currently enrolled at UNSW.' },
    { name: 'Echo', question: 'Worried about sharing your concerns?', category: 'mentor', answer: 'All information we gather is completely confidential. Your personal information will not be shared with anyone without your consent, this includes your faculty or lecturers. For further information, see our privacy statement by clicking here. ' },
    { name: 'Skylar', question: 'What can I expect if offered an appointment?', category: 'vacation', answer: 'Appointments are scheduled to last around 30 minutes. We will ask you some questions to help work out what might help. We always work with you as an individual and will always treat you with respect.', video: 'https://youtu.be/wm5nhB0lYL8' },
  ])
  ...
  const SingleQA = (props) => {
    ...
    return (
      <div style={{ display: 'flex' }}>
        ...
        <div>
          <Typography sx={{ margin: '10px' }}>{props.data.answer} </Typography>
        </div>
      </div>
    )
  }
