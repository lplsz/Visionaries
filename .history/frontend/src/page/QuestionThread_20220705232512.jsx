      ...
      >
        ...
        >
          {qaList.map((q, i) => {
            if (q.new !== 0) {
              return (
                <StyledBadge color="secondary" badgeContent={q.new}> <Tab classes={{ wrapper: { textAlign: "right" } }} label={<div style={{ textAlign: 'left' }}>{q.question}</div>}{...a11yProps(i)} sx={{ minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start" }} /></StyledBadge>
              )
            } else {
              return (
