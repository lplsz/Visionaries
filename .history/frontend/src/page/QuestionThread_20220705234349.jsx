      ...
      <div style={{ marginLeft: '80px', marginRight: '80px' }}>
        ...
        >
          <Tabs
            ...
            sx={{
              borderRight: 1, borderColor: 'divider', width: 300, float: 'left',
            }}
          >
            {qaList.map((q, i) => {
              if (q.new !== 0) {
                return (
                  <Tab classes={{ wrapper: { textAlign: "right" } }} label={<StyledBadge color="secondary" badgeContent={q.new}><div style={{ textAlign: 'left', width: '100%' }}>{q.question}</div></StyledBadge>}{...a11yProps(i)} sx={{ minWidth: '100%', width: '100%', right: '0', alignItems: "flex-start", paddingRight: 20 }} />
                )
              } else {
                return (
