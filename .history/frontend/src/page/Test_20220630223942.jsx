  ...
  return (
    <div style={{ width: '300px', height: '300px' }} >
      ...
      <Grid container spacing={0} cent>
        <Grid item xs={2.4} sx={{ background: '#ea9999', color: '#ebb6b6', textAlign: 'center' }}>
          MON
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#f9cb9c', color: '#f7dbbe', textAlign: 'center' }}>
          TUE
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#ffe599', color: '#fcecbf', textAlign: 'center' }}>
          WED
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#a2c4c9', color: '#c4d8db', textAlign: 'center' }}>
          THU
        </Grid>
        <Grid item xs={2.4} sx={{ background: '#aa9dcb', color: '#beb6d2', textAlign: 'center' }}>
          FRI
        </Grid>
      </Grid>
