...
const ExpertMain = () => {
  ...
  const SingleQA = (props) => {
    ...
    return (
      <div>
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', marginTop: '0px', marginBottom: '10px', marginRight: '10px' }}> <Typography sx={{ fontSize: '6px' }}>{props.data.time} </Typography></div>
